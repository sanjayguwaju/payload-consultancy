...
export const ReviewType2 = (props: any) => {
          ...
          <div className="grid gap-8 sm:grid-cols-1  md:grid-cols-2 lg:grid-cols-3">
            {reviews &&
              reviews?.map((review: any, index: number) => (
                <div
                  key={index}
                  className="p-6 bg-amber-50 rounded-2xl shadow dark:bg-gray-800 relative overflow-hidden"
                >
                  ...
                  {/* Folded Corner */}
                  <div className="absolute bottom-0 right-0 w-10 h-10 bg-gray-200 dark:bg-gray-700 transform rotate-45 origin-bottom-left"></div>
                </div>
              ))}
          </div>
        </div>
