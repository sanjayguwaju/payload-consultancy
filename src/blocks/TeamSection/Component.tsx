          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-6">
            {media?.map((item: any, index: any) => (
              <div key={index} className="bg-card p-4 rounded-lg shadow-md flex flex-col items-center justify-center">
                <img aria-hidden="true" alt={item.alt} src={item?.mediaItem.url} className="mb-4" />
            ...
            <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
              {media?.map((item: any, index: number) => (
                <div key={index} className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
                    <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={item?.mediaItem.url}  alt="Bonnie Avatar" />
                  </a>
                  <div className="p-5">
